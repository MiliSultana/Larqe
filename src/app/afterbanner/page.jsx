      ...
      <div className="mx-auto px-6 lg:px-12 xl:px-[134px] 2xl:px-[134px]">
        <div className="flex flex-col lg:flex-row gap-4 xl:gap-6 neue-pro">
          ...
          <div className="flex flex-col gap-4 lg:gap-6 w-full">
            {/* Men */}
            <div className="relative w-full h-[250px] sm:h-[300px] lg:h-[324px] overflow-hidden">
              <Image
              ...
              <div className="absolute top-8 left-6 text-black">
                ...
                <h2 className="text-[24px] md:text-[30px] font-bold tracking-[-1px] text-[#282828] mb-[11px]">
                  Mens
                </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 xl:gap-6 w-full">
              {/* Footwear */}
              <div className="relative w-full sm:w-1/2 h-[250px] sm:h-[300px] lg:h-[302px] overflow-hidden">
                <Image
                ...
                <div className="absolute top-6 left-6 text-black">
                  ...
                  <h2 className="text-[24px] md:text-[30px] font-bold tracking-[-1px] text-[#282828]">
                    Footwear
                  </h2>
                </div>
              </div>
